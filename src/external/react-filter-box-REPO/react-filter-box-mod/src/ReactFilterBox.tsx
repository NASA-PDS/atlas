...
export default class ReactFilterBox extends React.Component<any, any> {
    ...
    constructor(props: any) {
        super(props)
        this.parser = new FilterQueryParser(this.props.getAutocompleteValues)
        ...
        var autoCompleteHandler =
            ...
            new GridDataAutoCompleteHandler(
                this.props.data,
                this.props.options,
                this.props.getAutocompleteValues
            )
    ...
    async needAutoCompleteValues(codeMirror: any, text: string) {
        let suggestions = await this.parser.getSuggestions(text)
        suggestions = suggestions.slice(0, this.props.maxAutoCompleteSize || 100)
        return suggestions
    }
    ...
    onSubmit(query: string) {
        ...
        return this.props.onParseOk(result, query)
    }
        ...
        return (
            <div className={className}>
                <FilterInput
                    ...
                    refreshUntilMs={this.props.refreshUntilMs}
                />
            </div>
        )
    }
