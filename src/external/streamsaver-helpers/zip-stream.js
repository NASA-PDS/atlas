...
function createWriter(underlyingSource) {
    ...
    function closeZip() {
        ...
        cdOffset = offset
        if (cdOffset + length >= 0xffffffff || totalEntries >= 0xffff) zip64 = true
        ...
        for (indexFilename = 0; indexFilename < totalEntries; indexFilename++) {
            ...
            if (file.offset >= 0xffffffff) data.view.setUint32(index + 42, 0xffffffff, true)
            else data.view.setUint32(index + 42, file.offset, true)
